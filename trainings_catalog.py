...
TRAININGS: list[Training] = [
    Training(
        ...
        description=(
            "<b>Программа из 6 онлайн-встреч.</b>\n\n"
            "Учимся понимать, как устроен стресс, как он влияет на мышление "
            "и тело — и как этим состоянием управлять.\n\n"
            "В программе:\n"
            "— управление вниманием и осознанность\n"
            "— работа с ловушками мышления\n"
            "— дыхательные и телесные техники регуляции\n\n"
            "К концу — системный набор базовых навыков: быстрее восстанавливаться, "
            "не доводить себя до перегрева, держать устойчивость под нагрузкой.\n\n"
            "<b>Выберите одну из трёх групп ниже 👇</b>"
        ),
        groups=[
            TrainingGroup(
                id="er_g1",
