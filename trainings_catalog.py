...
TRAININGS: list[Training] = [
    Training(
        ...
        groups=[
            ...
            TrainingGroup(
                id="er_g4",
                title="4️⃣ Группа 4",
                starts_at=datetime(2026, 9, 3, 15, 0, tzinfo=MSK),
                leader="Аня Бондаренко",
            ),
        ],
    ),
    Training(
        ...
        title="🌱 Тренинг ресурсного состояния",
        description=(
            "Если тренинг навыков эмоциональной устойчивости направлен в первую "
            "очередь на совладание со стресс-триггерами и снижение интенсивных "
            "эмоций, то фокус этого тренинга — как сохранять эффективность и "
            "качество жизни, даже когда стресс и высокая нагрузка остаются.\n\n"
            "Эти тренинги взаимодополняют друг друга. Но это две самостоятельные "
            "программы — и они будут полезны по отдельности.\n\n"
            "<b>В течение шести недель мы будем развивать навыки "
            "психологической гибкости:</b>\n"
            "— управлять вниманием и возвращаться к текущей задаче\n"
            "— замечать тревожные и самокритичные мысли, не позволяя им "
            "автоматически влиять на поведение\n"
            "— спокойнее выдерживать сложные эмоции и не тратить все силы "
            "на борьбу с ними\n"
            "— определять свои ценности и приоритеты\n"
            "— переводить ценностные ориентиры в конкретные цели и действия\n"
            "— продолжать двигаться вперёд, даже когда нет уверенности, "
            "мотивации или идеального внутреннего состояния\n\n"
            "Результат программы — не жизнь без стресса, а поддержание "
            "ресурсного состояния, чтобы лучше понимать, что сейчас важно, "
            "выбирать свою реакцию и направлять энергию на значимые задачи "
            "вместо бесконечной борьбы с мыслями и переживаниями.\n\n"
            "<b>Формат:</b>\n"
            "— 6 встреч по 1 часу 45 минут в небольших группах\n"
            "— это не набор разрозненных лекций, а последовательная система "
            "навыков, где темы и инструменты выстроены в логике постепенного "
            "освоения и внедрения в жизнь\n"
            "— это не психотерапия: здесь не нужно «раскрывать душу» или "
            "рассказывать что-то личное. Это практические тренинги, где каждый "
            "сам определяет комфортный уровень участия\n"
            "— внутри будут короткие интерактивные теоретические блоки и, "
            "главное, практические инструменты, которые можно сразу пробовать "
            "и адаптировать под себя: упражнения на внимание и осознанность, "
            "работа с внутренними барьерами, постановка личных целей с опорой "
            "на ценности и поддержание мотивации"
        ),
        groups=[
            TrainingGroup(
                id="pf_g1",
                title="1️⃣ Группа 1",
                starts_at=datetime(2026, 8, 13, 15, 0, tzinfo=MSK),
                leader="Женя Янке",
            ...
            TrainingGroup(
                id="pf_g2",
                title="2️⃣ Группа 2",
                starts_at=datetime(2026, 9, 16, 15, 0, tzinfo=MSK),
                leader="Катя Хорошавцева",
                duration_minutes=105,
            ),
            TrainingGroup(
                id="pf_g3",
                title="3️⃣ Группа 3",
                starts_at=datetime(2026, 10, 14, 15, 0, tzinfo=MSK),
                leader="Женя Янке",
                duration_minutes=105,
            ),
        ],
